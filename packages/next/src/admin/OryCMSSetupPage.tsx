...
/**
 * The OryCMS first-run setup page. Provisions the initial Owner account via
 * `POST /api/orycms/auth/setup` (which installs the schema + seeds roles), then
 * redirects to `/login`. Mount it from a consumer `app/setup/page.tsx`.
 */
export function OryCMSSetupPage() {
